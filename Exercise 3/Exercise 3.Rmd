...
1.	Although there may be a correlation between "Crime" and "Police", there is not a guarantee that there is a direct causation between the two variables on their own.  In other words, there can be other factors that can influence "Police" levels within a city that will subsequently affect the level of "Crime."
